...
void harryPotterizeSequence(std::vector<std::string> &inputImageNames, std::vector<std::string> &outputImageNames, std::vector<R2Image::Marker> &markers) {
  ...
  for (int i = 0; i < 1; i++) {
    ...
    image_frame->identifyCorners(markers);
